...
import { ZonesDataProvider, useZonesData } from "@/components/providers/zonesProvider";
import { BinsDataProvider, useBinsData } from "@/components/providers/binsProvider";
import { ProductsDataProvider, useProductsData } from "@/components/providers/productsProvider";
						...
						>
							...
							<Button
								...
								className={`flex flex-col items-center w-full h-auto ${
									panel.type === ZonePanel && showPanel
										? "invert grayscale"
										: ""
								}`}
							>
							...
							<Button
								...
								className={`flex flex-col items-center w-full h-auto ${
									panel.type === OrdersPanel && showPanel
										? "invert grayscale"
										: ""
								}`}
							>
