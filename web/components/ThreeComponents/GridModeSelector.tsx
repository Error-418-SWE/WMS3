...
export function GridModeSelector({
	...
	return (
		<div
			className={
				"absolute bottom-4 right-4 p-2 pl-4 flex gap-4 items-center bg-slate-300 bg-opacity-50 rounded-lg shadow-md"
			}
		>
			...
			>
				<ToggleGroupItem
					value="0"
					aria-label="Disattiva griglia di collocamento"
				...
				<ToggleGroupItem
					value="0.1"
					aria-label="Passo griglia 10 centimetri"
					className="data-[state=on]:pointer-events-none"
				>
					<span>0.1</span>
				</ToggleGroupItem>
				<ToggleGroupItem
					value="0.5"
					aria-label="Passo griglia 50 centimetri"
					className="data-[state=on]:pointer-events-none"
				>
					<span>0.5</span>
				</ToggleGroupItem>
				<ToggleGroupItem
					value="1"
					aria-label="Passo griglia 1 metro"
					className="data-[state=on]:pointer-events-none"
				>
					<span>1.0</span>
				</ToggleGroupItem>
